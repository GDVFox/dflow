...
func HandleHelp() {
	pterm.DisableColor()
	pterm.DefaultBasicText.Printfln("Usage: dflow ADDRESS CATERGORY COMMAND [OPTIONS]")
	pterm.Println()
	...
	pterm.Println()
	pterm.DefaultBasicText.Printfln("Use 'dflow ADDRESS CATERGORY COMMAND --help' to see command [OPTIONS]")
